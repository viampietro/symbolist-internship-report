...
\input{PresentationDeSymbolist/geneseSymbolist.tex}	

\section{Analyse de l'existant}
\label{sec:analyseSymbolist}
\input{PresentationDeSymbolist/analyseSymbolist.tex}
...
\input{DeveloppementDeSymbolist/restructurationSymbolist.tex}
