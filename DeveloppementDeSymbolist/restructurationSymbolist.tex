...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio=true, width=0.8\textwidth]{DeveloppementDeSymbolist/i/graphicCompBefore.png}
...
\begin{figure}[H]
	\centering
	\includegraphics[keepaspectratio=true, width=0.8\textwidth]{DeveloppementDeSymbolist/i/graphicCompAfter.png}
